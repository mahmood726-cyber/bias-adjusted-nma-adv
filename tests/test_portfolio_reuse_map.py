...
def test_portfolio_reuse_map_names_source_constrained_reuse_lanes():
    ...
    for required in (
        ...
        "effect evidence from AACT/ClinicalTrials.gov records, public numeric ICTRP/PACTR result rows, PubMed abstracts, open-access papers, and public FDA/EMA regulatory review rows with numeric per-trial provenance",
